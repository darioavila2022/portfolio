            ...
            <div class="container">
                <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                    ...
                    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
                        <li class="ms-3"><a class="text-muted" href="#"><img src={instagram} width="30" height="24" alt="Twitter"/></a></li>
                        ...
                        <li class="ms-3"><a class="text-muted" href="#"><img src={stackoverflow} width="30" height="24" alt="Twitter"/></a></li>
                        ...
                        <li class="ms-3"><a class="text-muted" href="#"><img src={facebook} width="30" height="24" alt="Twitter"/></a></li>
                        <li class="ms-3"><a class="text-muted" href="#"><img src={reddit} width="30" height="24" alt="Twitter"/></a></li>
                    </ul>
                </footer>
            </div>
        </div>
